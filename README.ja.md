...
### また、親スレッドと子スレッドの作成も簡単にできます。  
親スレッドではメインの話だけして、子スレッドに渡す伝文マクロを親スレッドに作ってもらい、  
新しいスレッドで伝文マクロを貼れば子スレッドになり、  
子スレッドの会話が終わったら親スレッド向けの伝文マクロを作成して、それを親スレッドに貼れば伝文マクロを介した親子スレッド構造ができます。  
もちろん子スレッドはいくつもできますし、孫スレッド、ひ孫スレッドも立てられます。
