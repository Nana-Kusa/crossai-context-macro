...
🧠 また、2025年5月の追加検証により、Gemini 2.5 Flash は永続的なメモリを持たないにもかかわらず、明確に構造化された伝文マクロとその再利用意図を示すことで、セッションを超えた議論の再開が可能であることが確認されました。

これは、Gemini が伝文マクロを再利用可能な構造として内部的に認識していることを示唆しています。
